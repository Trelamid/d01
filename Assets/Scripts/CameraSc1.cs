...
public class CameraSc1 : MonoBehaviour
{
    public GameObject _yellow;
    public GameObject _blue;
    public GameObject _red;
    private playerScript_ex01 _yellowSc;
    private playerScript_ex01 _blueSc;
    private playerScript_ex01 _redSc;
    ...
    void Start()
    {
        _blueSc = _blue.GetComponent<playerScript_ex01>();
        _yellowSc = _yellow.GetComponent<playerScript_ex01>();
        _redSc = _red.GetComponent<playerScript_ex01>();
